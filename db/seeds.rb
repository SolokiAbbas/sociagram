...
post29 = Post.create!({title: "Rock Bands", body:"The big rock band", author_id: user15.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post8.png"})
post30 = Post.create!({title: "Gives you", body:"Something new", author_id: user16.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post8.png"})
post31 = Post.create!({title: "Niles", body:"The Crane", author_id: user16.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post8.png"})
...
post35 = Post.create!({title: "Hunting", body:"We are hunting Ducks", author_id: user18.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post6.png"})
post36 = Post.create!({title: "Dancing", body:"Dancing in September", author_id: user18.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post6.png"})
post37 = Post.create!({title: "Games", body:"Are we playing??", author_id: user18.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post7.png"})
...
post39 = Post.create!({title: "Town", body:"This is just it", author_id: user18.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post10.png"})
post40 = Post.create!({title: "Where", body:"Where are you going", author_id: user18.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post10.png"})
...
comment16 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment17 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment18 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment19 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment20 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment21 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment22 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment23 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment24 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment25 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment26 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment27 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment28 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment29 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
comment30 =  Comment.create!({body: Faker::StarWars.quote, author_id: user5.id, post_id: post10.id})
