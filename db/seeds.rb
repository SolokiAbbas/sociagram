...
post18 = Post.create!({title: "Just Here", body:"Come here guys", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post19 = Post.create!({title: "Riot", body:"Lets start one!", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post20 = Post.create!({title: "Beatles", body:"Here they come", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post21 = Post.create!({title: "Oasis", body:"You are my wonderwall", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post22 = Post.create!({title: "Kid", body:"There's a new kid in town", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post23 = Post.create!({title: "Geee", body:"Geeee wiz", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post24 = Post.create!({title: "Get my Lawyer", body:"Get a new one", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post25 = Post.create!({title: "Frasier", body:"Crane", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post26 = Post.create!({title: "Lineage", body:"The ultimate", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post27 = Post.create!({title: "New Girl", body:"Theres a new one", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post28 = Post.create!({title: "The 90s", body:"The rock band", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post29 = Post.create!({title: "Rock Bands", body:"The big rock band", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post30 = Post.create!({title: "Gives you", body:"Something new", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
