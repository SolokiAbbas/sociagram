          ...
          <div className="modal-likes-container">
            <div>
              ...
              <img className="bubble" onClick={() => this.handleCommentClick(this.props.post.id)} src={"https://s3.amazonaws.com/sociagram-dev/posts/icons/comment-bubble.png"}/>
                {ok_bookmark ? this.props.saved ? <img className="bookmark-modal" src={'https://s3.amazonaws.com/sociagram-dev/posts/icons/bookmark-black.png'}
                    onClick={() => this.handleRemoveBookmark(bookmarkid)} data-toggle="tooltip" data-placement="top"  data-dismiss="modal" title="Bookmark"/> :
                    <img className="bookmark-modal" src={'https://s3.amazonaws.com/sociagram-dev/posts/icons/bookmark-black.png'}
