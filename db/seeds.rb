...
post17 = Post.create!({title: "What's up", body:"The ceiling", author_id: user10.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post18 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post19 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post20 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post21 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post22 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post23 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post24 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post25 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post26 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post27 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post28 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post29 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post30 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post31 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post32 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post33 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post34 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post35 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post36 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post37 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post38 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post39 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
post40 = Post.create!({title: "Names", body:"Is it just me or is the naming of my family weird?", author_id: usertest.id, image: "https://s3.amazonaws.com/sociagram-dev/posts/postimages/post15.png"})
